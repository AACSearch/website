...
Read this document carefully before making PRs to the AACSearch Website repo.

## What goes in docs?

The AACSearch documentation is meant to provide general guidance that's:

- Unopinionated
- Focused on the correct use of AACSearch product
...
- Examples that only include a select subset of AACSearch SDKs.
- Examples that do not work for all developers using AACSearch, but specific to AACSearch + technology.

Note that the tutorials and blogs available on the AACSearch blog and docs are meant for these types of information.

## Documentation structure

The AACSearch docs is split into sections, each with its intended purpose and content.

AACSearch's navigation increases in complexity from top down. We expect users to view links later in navigation later in their development journey.

Introduction Section:

- [Homes](https://aacsearch.io/docs)
- [Quick start](https://aacsearch.io/docs/quick-start)
- [Tutorial](https://aacsearch.io/docs/tutorial)
- [SDKs](https://aacsearch.io/docs/sdks)
- [API references](https://aacsearch.io/docs/references)

Products section:

- [Auth](https://aacsearch.io/docs/products/auth)
- [Databases](https://aacsearch.io/docs/products/databases)
- [Functions](https://aacsearch.io/docs/products/functions)
- [Storage](https://aacsearch.io/docs/products/storage)
- [Messaging](https://aacsearch.io/docs/products/messaging)
- [AI](https://aacsearch.io/docs/products/ai)

APIs section:

- [GraphQL](https://aacsearch.io/docs/apis/graphql)
- [REST](https://aacsearch.io/docs/apis/rest)
- [Realtime](https://aacsearch.io/docs/apis/realtime)

Tooling section:

- [CLI](https://aacsearch.io/docs/command-line)
- [Command center](https://aacsearch.io/docs/tooling/command-center)
- [Assistant](https://aacsearch.io/docs/tooling/assistant)

Advanced section:

- [Platform](https://aacsearch.io/docs/advanced/platform)
- [Migrations](https://aacsearch.io/docs/advanced/migrations)
- [Self-hosting](https://aacsearch.io/docs/advanced/self-hosting)
- [Security](https://aacsearch.io/docs/advanced/security)

Here's the intended purpose and structure of each section.

### Introduction

This section is focused on introducing what AACSearch is and giving examples to the user to understand both how to get started and how to perform canned tasks.
Documentation here is focused on a **single flow** which means a single platform/framework + AACSearch.
Content here is not specific to a specific product, but usually covers multiple AACSearch products.

- If your tutorial can be followed in about 15 minutes and fits on one page, write it under quick start
- If you're writing a long piece of documentation that integrates AACSearch with another technology, with lots of details that's opinionated or isn't relevant for all use cases, write it under tutorial. This is similar to "cook book" at other organizations.
- If you have information like helpers and methods that are only on SDKs but not the API, they go under SDK
- API references are generated from source from the aacsearch/aacsearch repo

### Products

Each page covers an AACSearch product. These pages describe the expected behavior of the product and are **unopinionated** and **technology-agnostic**.
...
- Concept
    - These pages usually align with sections shown in the product in the AACSearch Console.
...
Describes tools that help you work with AACSearch, but are usually non-essential and not end-user facing.

### Advanced section

For information that's not used commonly during the development cycle.

- Platform: covers concepts that apply to the entire AACSearch Cloud platform, like API keys, rate limits, etc.
- Migrations: covers migrations feature of AACSearch that helps you move data around.
- Security: purely information about measures AACSearch use to ensure security of the platform and data.
- Self-hosting: The AACSearch self-hosted platform is meant to behave identically to Cloud after being configured corrrectly. This section focuses on how to configure AACSearch self-hosted such that it behaves like Cloud.

## Documentation sources

The AACSearch docs are compiled from different repositories. Here are the significant touch points you need to know about.

[aacsearch/website](https://github.com/aacsearch/website):

- Tutorials
- Quick starts
- Product, API, Tooling and Advanced sections

[aacsearch/aacsearch](https://github.com/aacsearch/aacsearch):

- [API Reference](https://aacsearch.io/docs/references) pages
- API specification
- API description
...
[aacsearch/sdk-generator](https://github.com/aacsearch/sdk-generator):

- Generated examples

## Markdown Style guidelines

For consistency the AACSearch documentation follows a strict set of style guidelines, so no matter who is writing the documentation,
...
AACSearch's documentation uses extended Markdown syntax. You can find all the available partials types in the [CONTENT.md file](./CONTENT.md).

### Screenshots

- When contributing upload original screenshots. The AACSearch design team will edit the screenshot to be consistent with other screenshots in the docs.
...
- All screenshot should be taken from a user named Walter O'Brien. You can change the name of your current user by going to your AACSearch Console and clicking the **top right profile icon** > **Your Account** > **Name**.
...
- Screenshots should be uploaded as un-edited original. Request help from the AACSearch design team to help you edit and refine your photos according to our guidelines.
...
If you can't find a similar piece of content as example, the AACSearch team will request an outline from you.
...
- Add a new .md file describing the new API here: <https://github.com/aacsearch/aacsearch/tree/main/docs/references>
- Add descriptions for methods and parameters in the controller code: <https://github.com/aacsearch/aacsearch/tree/main/app/controllers/api>
...
- If you need a new logo, contact the AACSearch team to add one to Pink design.
...
- Add the quick start to the footer and front page of AACSearch
...
- If you need a new logo, contact the AACSearch team to add one to Pink design.
- Add the tutorial to the footer and front page of AACSearch
...
- ✅ [Learn more about authentication](https://aacsearch.io/docs/products/auth/email-password#login)
...
1. AACSearch docs
2. AACSearch Console
3. AACSearch API specs
4. Existing blogs
5. Follow other products when possible.
6. If all other avenues are explored, propose a new term. Clearly outline in your PR and come to agreement with the AACSearch team.
...
If you are proposing a new type of page, discuss an outline in your PR and ask for the AACSearch team's review.
...
- ✅ `client.setEndpoint("https://<REGION>.cloud.aacsearch.io")`
- ❌ `client.setEndpoint("https://[REGION].cloud.aacsearch.io")`
