...
const mockIssues: Issue[] = [
    {
        number: 5232,
        url: 'https://github.com/aacsearch/aacsearch/issues/5232',
        title: 'Feature: Security Scans like SAST, DAST, FOSS, CAST in pipeline',
        repository: 'aacsearch/aacsearch',
        tags: ['Enhancement', 'Help Wanted', 'Discussion']
    },
    {
        number: 5748,
        url: 'https://github.com/aacsearch/aacsearch/issues/5748',
    ...
    {
        number: 680,
        url: 'https://github.com/aacsearch/sdk-generator/issues/680',
        title: 'Feature: Unit Tests',
        repository: 'aacsearch/sdk-generator',
        tags: ['Enhancement', 'Help Wanted', 'Discussion']
    },
    {
        number: 679,
        url: 'https://github.com/aacsearch/sdk-generator/issues/679',
        title: 'Feature: overload Feature for Storage.CreateFile for using Blob instead of File',
        repository: 'aacsearch/sdk-generator',
        tags: ['Enhancement', 'Help Wanted', 'Discussion']
    }
...
export const load = async () => {
    ...
    // fetch issues from GitHub, aacsearch/aacsearch repo
    const response = await fetch(
        'https://api.github.com/repos/aacsearch/aacsearch/issues?state=open'
    );
