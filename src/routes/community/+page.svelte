<script lang="ts" module>
    ...
    const baseEvent = {
        ...
        description:
            'Join us for another round of Office Hours, where we answer your questions and geek out on everything tech and AACSearch!',
...
<script lang="ts">
    ...
    const projects: ProjectCardProps[] = [
        {
            title: 'Auth UI',
            description: 'AACSearch-powered authentication screens generator for any application.',
            image: {
                src: 'https://cloud.aacsearch.io/v1/storage/buckets/thumbnails/files/64803bb4f34eb4b05ee3/preview?width=800&output=webp&project=builtWithAACSearch',
                alt: 'Auth UI: Fully customizable login flow for your applications'
            },
            href: 'https://builtwith.aacsearch.io/projects/6467cedd4502d0e29205/'
        },
        {
            title: 'Glitch',
            description: 'AACSearch-powered collaboration Tool for streamlined team communication.',
            image: {
                src: '/images/community/projects/glitch.png',
                alt: 'A screenshot of the Glitch dashboard. There\'s a sidebar, and a headline that reads: "Welcome to Glitch, powered by AACSearch"'
            },
            href: 'https://builtwith.aacsearch.io/projects/648bfe0c1d8d70602b0b/'
        },
        {
            title: 'uCanEarn',
            description:
                'AACSearch-powered platform where you can sell your digital products online.',
            image: {
                src: '/images/community/projects/ucanearn.png',
                alt: "A screenshot of uCanEarn's website"
            },
            href: 'https://builtwith.aacsearch.io/projects/648606ad9cd179190b28/'
        }
    ];
                    ...
                    <div class="web-hero is-align-start web-u-max-width-580">
                        ...
                        <div>
                            <p class="text-description">
                                Inspire and get inspired. Join AACSearch's community of maintainers
                                and contributors and help us make AACSearch better for developers
                                worldwide.
                            </p>
            ...
            <div class="web-big-padding-section-level-2">
                <div class="relative container">
                    <div class="web-hero is-mobile-center web-u-max-width-900 gap-5">
                        ...
                        <div>
                            <p class="text-description">
                                See contributors of AACSearch since 2019 and discover how you can
                                start contributing.
                            </p>
            ...
            <div class="web-big-padding-section-level-2">
                <div class="container">
                    <div class="web-hero is-align-start">
                        ...
                        <div>
                            <p class="text-description">
                                With every contribution, AACSearch gets better for all of us. Start
                                contributing today.
                            </p>
                        </div>
                    </div>
                        ...
                        >
                            <div>
                                ...
                                <p class="text-main-body mt-1 font-medium">
                                    Anyone can join and help AACSearch become better.
                                </p>
                                <Button
                        ...
                        <li>
                            ...
                            >
                                ...
                                <div class="text-sub-body">
                                    Help others discover AACSearch with videos and blogs.
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            >
                                ...
                                <div class="text-sub-body">
                                    Share your experience and represent AACSearch in public.
                                </div>
                            </div>
                        </li>
                        <li>
                ...
                <div class="container">
                    <div class="web-hero is-center">
                        ...
                        <p class="text-description web-u-margin-block-start-0">
                            Visit our showcase website built with AACSearch to find inspiration for
                            your projects or to showcase what you have built.
                        </p>
                        <Button
                            variant="secondary"
                            href="https://builtwith.aacsearch.io"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="mt-4 self-center"
                            event="community-builtwith_aacsearch-click"
                        >
                ...
                <div class="container">
                    <div class="web-grid-15-25-desktop web-u-row-gap-48 web-u-column-gap-96">
                        <div class="web-hero is-align-start web-u-max-width-380">
                            ...
                            <p class="text-description">
                                Discover AACSearch's community across platforms and join the fun.
                            </p>
                        </div>
                            ...
                            >
                                <section class="flex flex-col gap-5">
                                    ...
                                    <p class="text-description web-u-padding-block-end-40">
                                        ...
                                        AACSearch. Learn more about engineering, product design,
                                        building community, and tips & tricks for using AACSearch.
                                    </p>
                                </section>
                            </div>
                        </div>
