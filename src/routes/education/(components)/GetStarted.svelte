<script lang="ts">
    ...
    const items: Array<{
        ...
        },
        {
            ...
            description:
                'Create your AACSearch account through the Education program sign up page. Once verified, the Education plan will be applied to your account.',
            cta: { url: educationSignUp, label: 'Sign up' }
        },
        {
            label: 'Start from our docs',
            description:
                'Once your AACSearch account is created, go to our Docs and get started with AACSearch Cloud.',
            cta: { url: 'https://aacsearch.io/docs', label: 'Go to AACSearch Docs' }
        }
    ];
</script>
