    ...
    const items = [
        {
            ...
            description:
                'Get access to AACSearch Cloud and build your entire backend with AACSearch.',
            icon: Checkmark
        },
        {
            label: 'Build with any framework',
            description:
                'Get free access to build with AACSearch’s Education plan, valid throughout your student career.',
            icon: Beaker
        },
        {
            label: 'Join a vibrant community',
            description: 'Get community support in the AACSearch Discord server.',
            icon: ChatIcon
        }
    ];

    const educationSignUp = getAACSearchDashboardUrl('/console/education');
</script>
...
>
    ...
    >
        <Logos />
        <h1 class="font-aeonik-pro text-title text-white">Build your next project with AACSearch</h1>
        <p class="text-secondary font-medium">
            Join the AACSearch Education program in collaboration with the GitHub Student Developer
            Pack. Students access AACSearch Cloud for free throughout their studies.
        </p>
