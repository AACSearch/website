<script lang="ts">
    ...
    import AACSearchIn100Seconds from '$lib/components/AACSearchIn100Seconds.svelte';
...
<div class="relative flex max-w-screen items-center overflow-hidden py-12 md:py-0 lg:min-h-[700px]">
    ...
    >
        ...
        >
            <HeroBanner title="AACSearch Cloud is now GA" href="/cloud-ga" />
