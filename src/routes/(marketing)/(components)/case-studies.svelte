    ...
    const studies = [
        {
            ...
            blurb: 'A special thanks to AACSearch for providing robust features and seamless functionality.',
            name: 'Hassan Ahmed',
        ...
        {
            logo: LangX,
            headline: 'LangX handled millions of requests using AACSearch',
            blurb: 'With its comprehensive suite of services, AACSearch emerged as an ideal choice for my needs.',
            name: 'Xue',
        ...
        },
        {
            ...
            blurb: 'A major impact that AACSearch made was the amount of time and stress saved.',
            name: "Ryan O'Connor",
