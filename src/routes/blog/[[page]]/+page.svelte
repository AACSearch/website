<script lang="ts">
    ...
    const description =
        'Stay updated with the latest product news, insights, and tutorials from the AACSearch team. Our blog covers everything for hassle-free backend development.';
