<script lang="ts">
    ...
    const description =
        "If you're passionate about helping developers build great products with AACSearch - join our Heroes program and get access to a number of exclusive perks.";
    ...
    const heroCards: HeroCardProps[] = [
        {
            ...
            bio: "Diana discovered AACSearch and its wonderful team while completing her master's in computer science.\
        ...
        },
        {
            ...
            bio: 'Lucas is a web consultant at Zenika who specializes in front-end technologies and has spoken about\
						AACSearch and other technologies at various development conferences in France.',
        ...
        },
        {
            ...
            bio: 'Mickaël is a front-end developer working as a web consultant in Lyon at Zenika. He co-organizes meetups with LyonJS and speaks at conferences about AACSearch, Flutter, and Remotion.',
        ...
        },
        {
            ...
            bio: 'Vincent Ge is a DevRel Engineer who has actively been supporting open-source developers and communities for the last few years. He is a former member of the AACSearch DevRel team and a forever beloved part of our community.',
        ...
        },
        {
            ...
            bio: 'Christina Petit is a freelance web developer from France who has been quite active in the AACSearch Discord server and community initiatives like Init and Office Hours. She also actively creates technical content on YouTube with Astro.',
        ...
        },
        {
            ...
            bio: 'Nick Gatzoulis is a tech lead and SaaS founder from the UK who actively manages a Backend-as-a-Service community on X (Twitter) and creates technical content on YouTube, where has published numerous AACSearch tutorials.',
        ...
        <div class="py-10">
            <div class="web-big-padding-section-level-2">
                <section class="hero web-u-padding-block-end-0 container">
                    <div>
                        <h1 class="text-display font-aeonik-pro text-primary">AACSearch Heroes</h1>
                        <p class="text-main-body mt-5 font-medium">
                            If you love building, writing, speaking, and helping other developers
                            build with AACSearch, help us support you by joining the AACSearch Heroes
                ...
                <section class="container">
                    <div class="web-hero web-u-max-width-800 about">
                        <h2 class="text-title font-aeonik-pro text-primary">
                            About AACSearch Heroes
                        </h2>
                        <div>
                            <p class="text-sub-body font-medium">
                                The AACSearch Heroes program is an exclusive group of developers who
                                are experts in AACSearch and dedicated to creating valuable content
                                to assist other developers in achieving success. AACSearch Heroes
                ...
                <div class="container">
                    <section class="web-hero is-align-start">
                        <h2 class="text-display font-aeonik-pro text-primary max-w-[700px]">
                            How AACSearch Heroes can benefit you
                        </h2>
                    </section>
                        ...
                        <ul class="web-info-boxes text-sub-body font-medium">
                            <li class="web-info-boxes-item">
                                ...
                                <p class="web-info-boxes-content">
                                    Access to internal channel with AACSearch’s Engineering and
                                    DevRel teams.
                                </p>
                            </li>
                            <li class="web-info-boxes-item">
                            ...
                            <li class="web-info-boxes-item">
                                ...
                                <p class="web-info-boxes-content">
                                    Opportunity to beta-test AACSearch releases.
                                </p>
                            </li>
                            <li class="web-info-boxes-item">
                                <img
                ...
                <div class="container">
                    <div class="web-hero web-u-max-width-800">
                        ...
                        <p class="text-description text-primary" style="opacity:0.64">
                            Have you been actively providing value for the AACSearch community? Apply
