									...
									<div class="web-timeline-content-item-top web-grid-1-1"
										...
										<div class="flex flex-col gap-4">
											...
											<h3 class="text-title font-aeonik-pro text-primary">
												A passion project called AACSearch
											</h3>
											<p class="text-main-body">
												AACSearch's first ever pull request was submitted in August 2019 by CEO and Founder Eldad A. Fux. Just one month later, September 2019, AACSearch officially launched. Soon the community started contributing by the hundreds pushing the product to new heights.
											</p>
										</div>
										<div >
											<div class="web-media">
												<img  src="https://pink.aacsearch.io/articles/announcement.png" alt="" loading="lazy">
											</div>
										</div>
								...
								<li class="web-timeline-content-item">
									<div class="web-grid-1-1"
										...
										<div class="flex flex-col gap-4">
											...
											<p class="aw -main-body-400">
												Towards the end of 2022 we released AACSearch 1.0 and the Console 2.0 for a better developer experience. It was the first time we produced a product, the Console, which was fully designed by our in house team. These are the initial versions of the products you know today.
											</p>
										</div>
										<div>
											[image]
								...
								<li class="web-timeline-content-item">
									<div class="web-grid-1-1"
										...
										<div class="flex flex-col gap-4">
											...
											<p class="aw -main-body-400">
												Aligned with our mission to make software development more accessible, we added our cloud solution to our services. Opening up the doors for more developers to  build with AACSearch as they were not required to self-host anymore.
											</p>
										</div>
										<div>[image]</div>
									</div>
                ...
                <div class="container">
                    <div class="web-hero web-u-max-width-800">
                        ...
                        <p class="text-description web-u-max-width-480 mx-auto">
                            AACSearch is proudly backed by some of the top investors in the industry.
                        </p>
                    </div>
                ...
                <div class="container">
                    <div class="web-hero web-u-max-width-380">
                        ...
                        <p class="text-primary web-u-opacity-64">
                            Find your next career at AACSearch and join a team of remote workers.
                        </p>
                        <Button
