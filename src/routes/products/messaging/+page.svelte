<script>
    ...
    const description =
        'AACSearch Messaging allows you to communicate with your audience across various mediums. Push notifications, SMS and emails - set up within minutes!';
    const ogImage = DEFAULT_HOST + '/images/open-graph/website.png';

    const codeTopic = [
        {
            language: 'client-web',
            content: `import { Account, Messaging, ID } from "aacsearch"
...
await messaging.createSubscriber(
    ...
    targetId,            // Target ID
        ...
        },
        {
            ...
            content: `import 'package:aacsearch/aacsearch.dart';
...
await messaging.createSubscriber(
    ...
    targetId: targetId
        ...
        },
        {
            ...
            content: `import io.aacsearch.services.Account
import io.aacsearch.services.Messaging
import io.aacsearch.ID
    ...
    const codeMessage = [
        {
            ...
            platform: 'Node.js',
            content: `import { Messaging, ID } from "node-aacsearch"
...
await messaging.createPush(
    ...
    ['news', 'sport'],       // Topic IDs
        ...
        },
        {
            language: 'cs',
            platform: '.NET',
            content: `using AACSearch.Services.Messaging;
using AACSearch.ID;
...
await messaging.createPush(
    ...
    topics: ['news', 'sport'],
        ...
        },
        {
            language: 'kotlin',
            platform: 'Kotlin',
            content: `import io.aacsearch.services.Messaging
import io.aacsearch.ID
...
use AACSearch\Services\Messaging;
use AACSearch\ID;
...
$messaging->createPush(
    ...
    topics: ['news', 'sport']
        ...
        },
        {
            language: 'python',
            platform: 'Python',
            content: `from aacsearch.services.messaging import Messaging
from aacsearch.id import ID
            ...
            <div class="container">
                <div>
                    ...
                    <div class="hero-buttons mt-8 flex items-center gap-2">
                        <Button href={getAACSearchDashboardUrl()} class="w-full! md:w-fit!"
                            >Get started</Button
                        >
                        <Button
                            variant="secondary"
                    ...
                    <li class="web-u-flex-basis-378">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="text-sub-body">
                                    Scale big and unlock limitless potential with AACSearch
                                    functions.
                                </p>
                            </div>
                        </a>
                    ...
                    <li class="web-u-flex-basis-378">
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="text-sub-body">
                                    Utilize realtime information from all AACSearch services.
                                </p>
                            </div>
                        </a>
                    </li>
