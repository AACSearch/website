<script lang="ts">
    ...
    const description =
        'Get to know AACSearch Storage - our robust infrastructure allows you to store, optimize and encrypt all of your project files in one place.';
...
<Main>
    <div class="overflow-hidden">
        <Hero
            ...
            cta={{
                label: 'Get started',
                url: PUBLIC_AACSEARCH_DASHBOARD
            }}
            secondaryCta={{
                label: 'Documentation',
                url: '/docs/storage'
                    ...
                    <div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
                        <div class="web-hero is-align-start mx-auto md:mb-0 lg:!max-w-md">
                            ...
                            <p class="text-main-body font-medium">
                                AACSearch's Storage APIs allow you to create and update your files,
