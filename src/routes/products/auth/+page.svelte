<script>
    ...
    const description =
        'Enable secure and reliable user login with AACSearch Auth. We support multiple authentication methods with compliance features out of the box.';
                        ...
                        >
                            ...
                            >
                                ...
                                <p class="text-sub-body">
                                    Use AACSearch messaging to send email, SMS, and push
                                    notifications.
                                </p>
                            </div>
                        </a>
