<script lang="ts">
    ...
    const logs = [
        ...
        {
            time: '18:31:22.123',
            message: 'Running "aacsearch build"'
        },
        {
            time: '18:31:22.938',
            message: 'AACSearch CLI 37.6.1'
        },
        {
            time: '18:31:21.344',
            message: 'AACSearch network is enabled'
        }
    ];
...
`
        ...
        {
            eyebrow: 'Domain',
            label: 'https://hello-world.aacsearch.global'
        }
    ];
    ...
    <div class="flex w-full flex-col gap-8 md:pl-8">
        ...
        <div class="relative z-10 mx-auto -mt-24 flex max-w-md flex-col gap-4 text-center">
            ...
            <p class="text-secondary text-description font-medium">
                ...
                deployment logs to ensure a stable connection with the AACSearch network.
            </p>
        </div>
    </div>
</div>
