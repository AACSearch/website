<script lang="ts">
    ...
    const description = 'Apply for AACSearch Cloud Pro credits for your event.';
                                    ...
                                    {#if submitted}
                                        <section class="flex flex-col gap-5">
                                            ...
                                            <p class="web-description web-u-padding-block-end-32">
                                                Thank you for applying for an AACSearch hackathon
                                    ...
                                    {:else}
                                        <section class="flex flex-col gap-5">
                                            ...
                                            <p class="web-description">
                                                Hosting an event or hackathon? Apply for an AACSearch
                                                sponsorship and get $50 Cloud credits for all your
                                                attendees to build with AACSearch Pro.
                                            </p>
                                        </section>
                                    {/if}
                                </div>
                                        ...
                                        >
                                            ...
                                            <li class="web-form-item">
                                                ...
                                                <input
                                                    ...
                                                    class="web-input-text w-full"
                                                    type="url"
                                                    placeholder="https://aacsearch.io"
                                                    id="eventLink"
