    ...
    const items = [
        {
            title: 'Experts',
            description:
                'For agencies, consultancies, freelancers, and integrators who want to provide a scalable backend solution for their clients. Partner with AACSearch to provide a highly custom solution with the newest technology.',
        ...
        },
        {
            title: 'Integrations',
            description:
                'For innovative software companies striving to create solutions that integrate seamlessly with our platform. Partner with AACSearch to create a better developer experience.',
            href: '/integrations',
