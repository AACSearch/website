<script lang="ts">
    ...
    const shareTextOptions = [
        `Join us during the week of ${initDates} to celebrate everything new with @aacsearch. Claim your ticket here 👇 ${ticketUrl}`,
        `Come celebrate everything new with @aacsearch from ${initDates}! Don't miss out on the latest features and updates. Get your ticket ASAP! 📅 ${ticketUrl}`,
        `Don't miss out on init @aacsearch from ${initDates}. Get your ticket now and join us for a week of innovation. 🚀 ${ticketUrl}`,
        `Join us ${initDates} to explore everything new with @aacsearch. Reserve your spot and be the first to know about the latest features 📌 ${ticketUrl}`,
        `Join the fun! We're celebrating everything new with @aacsearch from ${initDates}. Secure your ticket here 🎟️ ${ticketUrl}`,
        `We're celebrating everything new with @aacsearch from ${initDates}. Come join us and see what's in store. Get your ticket 🗓️ ${ticketUrl}`,
        `Join us for an incredible week of exploring everything new with @aacsearch, ${initDates}. Get your ticket here ✨ ${ticketUrl}`,
        `Join us ${initDates} to see everything new with @aacsearch. Claim your ticket and be the first to experience the FRESH updates 👇 ${ticketUrl}`,
        `Let's celebrate everything new with @aacsearch from ${initDates}. Grab your ticket and join us for a week full of surprises 🎁 ${ticketUrl}`,
        `Be part of everything new with @aacsearch from ${initDates}. Get your ticket here: ${ticketUrl}`,
        `Join the fun! ${initDates}, let's check out everything new with @aacsearch together. Get your ticket and don't miss out 🎟️ ${ticketUrl}`,
        `I'm attending init @aacsearch from ${initDates}. Come along and experience the latest features with us. Get your ticket 🎫 ${ticketUrl}`,
        `Don't miss out on the fun! Join us at @aacsearch init from ${initDates}. Get your ticket here 🔥 ${ticketUrl}`,
        `My ticket looks so good! I'll be at @aacsearch init from ${initDates}. Join us and be the first to explore the updates 🌐 ${ticketUrl}`,
        `Spot my GitHub contribution graph! 🔥 Let's explore everything new with @aacsearch from ${initDates}. Secure your spot right away! ${ticketUrl}`,
        `I'm excited for everything new with @aacsearch ${initDates}. Come check out all the cool stuff with me! ${ticketUrl}`,
        `It's finally happening! Grab your ticket here and don't miss out on everything new with @aacsearch from ${initDates} 🚀 ${ticketUrl}`,
        `Join us for a week of everything new with @aacsearch, ${initDates}. Get your ticket here: ${ticketUrl}`,
        `Don't miss out on everything new with @aacsearch from ${initDates}. Get your ticket here: 💡 ${ticketUrl}`,
        `Let's check out everything new with @aacsearch from ${initDates}. Secure your ticket and join us for a week full of awesomeness! 🎉 ${ticketUrl}`
    ];
...
<svelte:head>
    ...
    <meta property="og:title" content="AACSearch init_ - {firstName}'s Ticket" />
    <meta name="twitter:title" content="AACSearch init_ - {firstName}'s Ticket" />
    <!-- Description -->
    <meta
        name="description"
        content="Get your own ticket for AACSearch's brand new release event and get the chance to win prizes."
    />
    <meta
