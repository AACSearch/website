...
<script lang="ts">
    ...
    import PosterFutureAACSearch from './(assets)/posterFutureOfAACSearch.png';
    ...
    let days: Array<Omit<DayProps, 'index'>> = [
        {
            ...
            illustration: Sites,
            description:
                'Introducing the open-source Vercel alternative. A new AACSearch product that lets you deploy and host your websites and web apps right inside AACSearch.',
            url: 'https://www.youtube-nocookie.com/embed/0cERQxFjTW4',
            content: [
                {
                    title: 'Announcing AACSearch Sites',
                    url: '/blog/post/announcing-aacsearch-sites',
                    type: 'Blog'
                },
                {
                    title: 'How to host SSR web apps with AACSearch Sites',
                    url: '/blog/post/host-ssr-web-apps-sites',
                    type: 'Blog'
                },
                {
                    title: 'Get started with AACSearch Sites',
        ...
        },
        {
            ...
            description:
                'AACSearch and Flutter have always worked well together, and now, you can deploy your Flutter web apps directly from AACSearch Sites.',
            url: '/blog/post/hosting-flutter-web',
            content: [
                {
                    title: 'How to set up the Flutter starter template on AACSearch Sites',
                    url: '/blog/post/flutter-starter-sites',
                    type: 'Blog'
                },
                {
                    title: 'Building with AACSearch Sites template',
        ...
        },
        {
            ...
            description:
                'Introducing Dev Keys. A new AACSearch feature that lets you bypass rate limits *during local development*. No more slowdowns. No more artificial blockers. Just fast, uninterrupted building.',
            url: '/blog/post/announcing-dev-keys',
            content: [
                {
                    title: 'Improve your AACSearch developer experience with Dev Keys',
        ...
        },
        {
            ...
            description:
                'We have added support for two new image formats in AACSearch Storage: HEIC and AVIF. This will give you more tools to manage, manipulate, and serve images the way you need.',
            url: '/blog/post/new-image-formats-avif-heic',
            content: [
                {
                    title: 'Announcing HEIC and AVIF support: modern image formats now in AACSearch',
                    url: '/blog/post/new-image-formats-avif-heic',
                    type: 'Blog'
                },
                {
