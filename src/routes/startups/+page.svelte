<script lang="ts">
    ...
    const description =
        "Get cloud credits to fulfill all your startup's backend and hosting needs. Apply for AACSearch's Startups Program today.";
    ...
    const mariusBolik = testimonial(
        'Marius Bolik',
        'CTO // mySHOEFITTER',
        'AACSearch has been a tremendous asset in implementing our IT infrastructure. Not only is the software an absolute game-changer, but the team is always there when you need them.',
        'marius-bolik2'
    );
    ...
    const souvikSarkar = testimonial(
        'Souvik Sarkar',
        '@Jeet_2003',
        'With its robust feature set and open-source nature, AACSearch is the perfect choice for developers who want to build secure and scalable applications.',
        'souvik-sarkar'
    );
    ...
    const testimonials = [
        ...
        testimonial(
            'Gilbert Gonzalez',
            '@ggsotillo',
            'We reduced 80% time-to-market of our apps using AACSearch.',
            'gilbert-gonzalez'
        ),
        testimonial(
            'Eddie Jaoude',
        ...
        testimonial(
            'David Forster',
            'Creator // Open Mind',
            'AACSearch saved us a lot of money in comparison to Firebase since the amount of users grew quite fast and we needed a quick switch. I am still surprised how easy the implementation into Flutter was.',
            'david-forster'
        ),
        testimonial(
            'Marius Bolik',
        ...
        testimonial(
            "Ryan O'Conner",
            'Founder // K-Collect',
            'For me, AACSearch is the perfect backend solution. All you have to do is sign up, and your backend is ready to go. I have never seen such an innovative and easy-to-understand backend solution before!',
            'ryan-oconner'
        ),
        testimonial(
            'Diego Ferreyra',
        ...
        testimonial(
            'Alejandro Morales',
            '@alexparton',
            "I just migrated a project from Firebase to AACSearch: Authentication, Users, Databases and Storage. And I can't be more in love with it.",
            'alejandro-morales'
        ),
        testimonial(
            'Marius Bolik',
        ...
        testimonial(
            'Jonas Janssen',
            'Founder // UNDO',
            'Thanks to AACSearch and advances in technology, we were able to get an MVP out in 2-3 months with 1 developer.',
            'jonas-janssen'
        ),
        testimonial(
            'Zach Handley',
                ...
                <section class="web-u-padding-block-end-0 container">
                    ...
                    >
                        <h1 class="text-headline font-aeonik-pro text-primary">
                            Build your startup with AACSearch
                        </h1>
                        <p
                            class="text-description web-u-max-width-640 e-u-padding-inline-32-desktop mx-auto"
                        >
                            The AACSearch Startups Program supports your startup with an all-in-one
                            development platform for you to build your products. You will receive
                            Cloud credits and a discount for AACSearch's paid plans.
                        </p>
                    ...
                    >
                        <li class="mx-auto flex flex-col items-center gap-4">
                            ...
                            <div class="flex flex-col gap-2 text-center">
                                ...
                                <p class="text-body font-medium">
                                    Get discounts on AACSearch’s paid plans. We offer up to 80% on
                                    both Pro and Scale.
                                </p>
                            </div>
                        </li>
                        ...
                        <li class="mx-auto flex flex-col items-center gap-4">
                            ...
                            <div class="flex flex-col gap-2 text-center">
                                ...
                                <p class="text-body font-medium">
                                    Get community support and priority support from the AACSearch
                                    team.
                                </p>
                            </div>
                        </li>
                                ...
                                >
                                    <section class="flex flex-col gap-5">
                                        <h4 class="text-title font-aeonik-pro text-primary">
                                            Join the AACSearch Startups program
                                        </h4>
                                        ...
                                        <div class="flex flex-col gap-3">
                                            <div class="flex gap-4">
                                                ...
                                                >
                                                    AACSearch Cloud Pro for 12 months
                                                </p>
                                            </div>
                                            <div class="flex gap-4">
                                                <img
