<script lang="ts">
    ...
    const description =
        "Join AACSearch's Startups program and benefit from discounts and Cloud credits to cut your cloud costs.";
    ...
    <div class="web-big-padding-section">
        <div id="form" class="web-big-padding-section-level-1 overflow-hidden p-0">
                                ...
                                {:else}
                                    <section class="flex flex-col gap-5">
                                        <h1 class="text-display font-aeonik-pro text-primary">
                                            AACSearch for Startups
                                        </h1>
                                        <p class="text-description">
                                            Startups develop, deploy, and Scale with AACSearch. The
                                            ...
                                            <br />
                                            <br />
                                            Join the AACSearch Startups program and benefit from reduced
                                        ...
                                        <ul class="web-form-list grid w-full gap-4 md:grid-cols-2">
                                            ...
                                            <li class="web-form-item">
                                                ...
                                                <input
                                                    ...
                                                    class="web-input-text"
                                                    type="email"
                                                    placeholder="walter@aacsearch.io"
                                                    id="workEmail"
                                                    bind:value={email}
                                                />
                                            </li>
                                            ...
                                            <li class="web-form-item flex-col gap-1">
                                                ...
                                                <input
                                                    ...
                                                    class="web-input-text w-full"
                                                    type="text"
                                                    placeholder="aacsearch.io or https://aacsearch.io"
                                                    id="companyWebsite"
            ...
            <Scale
                ...
                theme="dark"
            >
                The switch to using AACSearch brought
