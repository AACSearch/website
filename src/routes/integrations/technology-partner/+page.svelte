<script lang="ts">
    ...
    const description =
        "Want to integrate your app with AACSearch's API? Apply to our Technology Partners program by filling a short form.";
                                        ...
                                        >
                                            ...
                                            {#if hasCreatedIntegration}
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        class="web-input-text"
                                                        type="url"
                                                        placeholder="https://aacsearch.io/docs"
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    class="web-input-text"
                                                    type="url"
                                                    placeholder="https://aacsearch.io/assets"
                                                    id="productUrl"
