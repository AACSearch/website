<script lang="ts">
    ...
    import Map from '$lib/components/aacsearch-network/map.svelte';
    ...
    <div class="mx-auto flex w-full max-w-6xl flex-col justify-center" use:useInView>
        <Grid rows={2} bottomBorder>
            ...
            <Cell column={4} columnStart={3} class="px-4 pb-8 md:py-30">
                <div class="space-y-8">
                    <p>
                        One of the exciting releases this year was the announcement of the AACSearch
                        Network. A network of cloud regions and edge locations (edges) to improve
                        AACSearch Cloud availability, performance, and compliance with local
                        regulations. We started with one region, Frankfurt, and we now have two more
                        up and running, and a lot more to come. AACSearch is committed to expanding
                    ...
                    <p>
                        ...
                        can build on top of AACSearch Cloud no matter your location.
                    </p>
                </div>
            </Cell>
