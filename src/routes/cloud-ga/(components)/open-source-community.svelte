            ...
            >
                <p>
                    We have said it a million times, and we will say it again: <span
                        ...
                        >Developer experience is at the top of the AACSearch list.</span
                    >
                </p>
                <p>
                    AACSearch has had the help of thousands of developers from the open-source
                ...
                <p>
                    AACSearch is grateful for every contribution, and we're committed to remaining
                    open-source. The AACSearch self-hosted instance will offer the same experience as
                    AACSearch Cloud, and our dedication to the Free plan remains unchanged. We're
                    ensuring AACSearch stays accessible for everyone to build with.
                </p>
            </Cell>
