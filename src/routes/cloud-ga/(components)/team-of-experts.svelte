<script lang="ts">
    ...
    const icons = [
        ...
        { label: 'AACSearch for Enterprise', src: Enterprise, href: '/contact-us/enterprise' }
    ];
</script>
        ...
        <Grid rows={2} bottomBorder>
            ...
            <Cell column={4} columnStart={3} class="px-4 pb-12 md:py-30"
                ><div class="text-paragraph-lg space-y-8">
                    <p>
                        The open-source community supporting AACSearch has been an undeniable
                        advantage in AACSearch’s success. You have been the first line of support
                        when AACSearch first started.
                    </p>
                    <p>
                        Today, AACSearch has scaled out that support with dedicated programs,
                        processes, resources, partners, and support engineers. No matter what you
                        are building, from students to enterprises, AACSearch helps you get to
                        production fast.
                    </p>

                    <p>
                        AACSearch doesn’t just provide you with an all-in-one development platform.
