        ...
        <Grid rows={2} bottomBorder>
            ...
            <Cell column={4} columnStart={3} class="px-4 pt-8 md:pt-30"
                ><p class="text-paragraph-lg">
                    ...
                    launched AACSearch private beta and enrolled users onto the platform bit by bit.
...
{#snippet MobileGraph()}
    <div
        ...
        style:--border-gradient-after="linear-gradient(180deg,rgba(255,255,255,0),transparent)"
    >
        <span class="text-primary text-base font-medium">The AACSearch<br /> Cloud GA journey</span>
