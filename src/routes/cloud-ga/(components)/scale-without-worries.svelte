<script lang="ts">
    ...
    const testimonials = [
        {
            blurb: 'A special thanks to AACSearch for shouldering the heavy lifting behind StoreAlert, providing robust features and seamless functionality that allow us to focus on what matters most.',
            name: 'Hassan Ahmed',
        ...
        {
            blurb: 'With its robust feature set and open-source nature, AACSearch is the perfect choice for developers who want to build secure and scalable applications without breaking the bank.',
            name: 'Souvik Sarkar',
            title: '@Jeet_2003',
            avatar: '/images/testimonials/souvik-sarkar.png'
        },
        {
            blurb: 'We really loved working with AACSearch for launching our bootstrapped "Open Mind" App. It was saving us a lot of money in comparison to Firebase since the amount of users grew quite fast and we needed a quick switch.',
            name: 'David Forster',
            title: 'MD',
            company: 'Open Mind',
        ...
        <Grid rows={3} bottomBorder>
            ...
            <Cell column={4} columnStart={3} class="px-4 pb-8 md:py-30">
                <p class="text-paragraph-lg">
                    AACSearch Cloud was built to scale, quietly and reliably. Over the past months,
