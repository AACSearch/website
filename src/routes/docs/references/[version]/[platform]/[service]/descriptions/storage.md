...
Using AACSearch permissions architecture, you can assign read or write access to each bucket or file in your project for either a specific user, team, user role, or even grant it with public access (`any`). You can learn more about [how AACSearch handles permissions and access control](/docs/advanced/platform/permissions).
