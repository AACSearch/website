The Sites service allows you to host, deploy and manage web applications directly within the AACSearch platform. You can use this service to create and manage sites, handle deployments, configure domains, and set up environment variables.
