    ...
    const tutorials: CodeCardProps[] = [
        {
            ...
            description: 'Learn AACSearch Auth, Databases, and more with React.'
        },
        {
            href: '/docs/tutorials/nextjs',
            cover: '/images/tutorials/nextjs.png',
            title: 'Next.js tutorial',
            description: 'Learn AACSearch Auth, Databases, and more with Next.js.'
        },
        {
            href: '/docs/tutorials/sveltekit',
            cover: '/images/tutorials/svelte.png',
            title: 'SvelteKit tutorial',
            description: 'Learn AACSearch Auth, Databases, and more with SvelteKit.'
        },
        {
            href: '/docs/tutorials/vue',
            cover: '/images/tutorials/vue.png',
            title: 'Vue tutorial',
            description: 'Learn AACSearch Auth, Databases, and more with Vue.'
        },
        {
            href: '/docs/tutorials/android',
            cover: '/images/tutorials/android.png',
            title: 'Android tutorial',
            description: 'Learn AACSearch Auth, Databases, and more with Android.'
        },
        {
            href: '/docs/tutorials/flutter',
            cover: '/images/tutorials/flutter.png',
            title: 'Flutter tutorial',
            description: 'Learn AACSearch Auth, Databases, and more with Flutter.'
        }
    ];
</script>
    ...
    <main class="web-main-section relative overflow-x-hidden" id="main">
        ...
        <section class="web-hero is-align-start e-hero-docs relative">
            ...
            <p class="text-description max-w-[600px]">
                AACSearch helps you build secure and scalable apps, faster. Leverage AACSearch's
        ...
        <section class="web-hero is-align-start is-no-max-width border-smooth border-t pt-12!">
            ...
            <p class="text-description max-w-[600px]">
                AACSearch’s Model Context Protocol (MCP) server lets LLMs interact directly with your
                AACSearch API.
            </p>
            <div class="mt-6">
        ...
        <section class="web-hero is-align-start is-no-max-width mt-12!">
            ...
            <p class="text-description max-w-[600px]">
                Choose how you integrate with AACSearch. Explore references for the AACSearch SDK,
                ...
                <ul class="web-grid-row-4">
                    <li>
                        ...
                        >
                            ...
                            <p class="text-sub-body mt-1">
                                Move data from self-hosted to AACSearch Cloud.
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            ...
                            <p class="text-sub-body mt-1">
                                Migrate users and data from Firebase to AACSearch.
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            ...
                            <p class="text-sub-body mt-1">
                                Migrate users and data from Supabase to AACSearch.
                            </p>
                        </a>
                    </li>
                    <li>
                        ...
                        >
                            ...
                            <p class="text-sub-body mt-1">
                                Migrate users and data from NHost to AACSearch.
                            </p>
                        </a>
                    </li>
                </ul>
