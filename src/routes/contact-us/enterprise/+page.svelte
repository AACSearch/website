<script lang="ts">
    ...
    const description =
        "Want to learn more about AACSearch's Enterprise plan? Send us a message, and we'll propose a pricing solution that fits your unique use case.";
                                ...
                                {:else}
                                    <section class="flex flex-col gap-5">
                                        <h1 class="text-display font-aeonik-pro text-primary">
                                            AACSearch for Enterprise
                                        </h1>
                                        <p class="text-description">
                                            Enterprise businesses partner with AACSearch to empower
