import {
    PUBLIC_AACSEARCH_COL_MESSAGES_ID,
    PUBLIC_AACSEARCH_COL_THREADS_ID,
    PUBLIC_AACSEARCH_DB_MAIN_ID
} from '$env/static/public';
import { databases } from '$lib/aacsearch';
import { Query } from '@aacsearch.io/console';
