<script lang="ts">
    ...
    const allProducts = {
        ...
        functions: {
            title: 'Functions',
            description: ' Scale big and unlock limitless potential with AACSearch functions.',
        ...
        messaging: {
            title: 'Messaging',
            description: 'Use AACSearch messaging to send email, SMS, and push notifications.',
