<script lang="ts">
    ...
    const plans: Array<{
    ...
    }> = [
        {
            ...
            buttonLink: getAACSearchDashboardUrl('/register'),
        ...
        },
        {
            ...
            buttonLink: getAACSearchDashboardUrl('/console?type=create&plan=tier-1'),
        ...
        },
        {
            ...
            buttonText: 'Start building',
            buttonLink: getAACSearchDashboardUrl('/console?type=create&plan=tier-2'),
            buttonVariant: 'secondary',
...
<div class="web-u-row-gap-80 relative grid gap-8 md:grid-cols-2">
    <section class="web-hero flex items-center justify-center gap-y-8">
        <h2 class="text-display font-aeonik-pro text-primary max-w-[500px] text-center">
            Start building with AACSearch today
        </h2>
        <Button
            variant="transparent"
            class="self-center"
