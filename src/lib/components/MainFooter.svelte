...
{#if variant === 'homepage'}
    <footer class="web-main-footer relative mt-12 flex flex-col justify-between gap-10 lg:flex-row">
        ...
        <div class="mt-1 grid grid-cols-1 gap-y-4 md:grid-cols-3">
            <div>Copyright © {year} AACSearch</div>

            <iframe
                class="w-full md:w-fit md:max-w-[230px]"
                title="AACSearch Status"
                src="https://status.aacsearch.online/badge?theme=dark"
                height="35"
                frameborder="0"
                scrolling="no"
            ...
            <ul class="web-main-footer-grid-1-column-3 web-main-footer-links items-end text-right">
                ...
                <li>
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onclick={() => trackEvent(`footer-aacsearch_status-click`)}>Status</a
                    >
                </li>
                <!-- <li>
					<a href="https://github.com/aacsearch/aacsearch/releases" target="_blank" rel="noopener noreferrer">Changelog</a>
				</li> -->
            </ul>
            <div class="web-main-footer-grid-1-column-4 web-main-footer-copyright">
                Copyright © {year} AACSearch
            </div>
        </div>
    </footer>
{/if}
