<script lang="ts" context="module">
    ...
    export const sublinks: Array<SubLink> = [
        {
            label: 'AACSearch vs. Supabase',
            href: '/blog/post/aacsearch-compared-to-supabase'
        },
        {
            label: 'AACSearch vs. Firebase',
            href: '/blog/post/open-source-firebase-alternative'
        },
        {
            label: 'AACSearch vs. Vercel',
            ...
            <div class="col-span-4 -ml-12 border-l border-white/6 pl-12">
                ...
                >
                    ...
                    >
                        ...
                        <p class="w-full text-pretty">
                            AACSearch helped reduce development time by 60%, and lower server costs
                            by 40%.
                        </p>
                    </a>
                </div>
                ...
                <div class="mt-8">
                    <span
                        ...
                        >Compare AACSearch<span class="text-accent">_</span></span
                    >
