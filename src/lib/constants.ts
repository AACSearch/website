...
export const SOCIAL_STATS: SocialStats = {
    GITHUB: {
        STAT: '52K',
        LINK: 'https://github.com/aacsearch/aacsearch',
        EXTRA: {
            COMMITS: '27K+',
            PULL_REQUESTS: '4.7K+',
            ISSUES: '3K+',
    ...
    TWITTER: {
        STAT: '127K+',
        LINK: 'https://twitter.com/intent/follow?screen_name=aacsearch'
    },
    YOUTUBE: {
        STAT: '13K+',
        LINK: 'https://www.youtube.com/c/aacsearch?sub_confirmation=1'
    }
};
...
export const partnerCategoryDescriptions: SearchableCategory[] = [
    {
        slug: 'agency',
        heading: 'Agency',
        description: 'Find an AACSearch Partner agency for your project'
    }
];
...
export const socials: Array<Social> = [
    {
        ...
        label: 'Discord',
        link: 'https://aacsearch.io/discord'
    },
    {
        icon: 'web-icon-github',
        label: 'Github',
        link: 'https://github.com/aacsearch'
    },
    {
        icon: 'web-icon-x',
        label: 'Twitter',
    ...
    },
    {
        icon: 'web-icon-linkedin',
        label: 'LinkedIn',
        link: 'https://linkedin.com/company/aacsearch'
    },
    {
        icon: 'web-icon-youtube',
        label: 'YouTube',
        link: 'https://youtube.com/c/aacsearch?sub_confirmation=1'
    },
    {
        icon: 'web-icon-daily-dev',
        label: 'Daily.dev',
        link: 'https://app.daily.dev/squads/aacsearch'
    },
    {
        icon: 'web-icon-bluesky',
        label: 'Bluesky',
        link: 'https://bsky.app/profile/aacsearch.io'
    },
    {
        icon: 'web-icon-tiktok',
        label: 'Tiktok',
        link: 'https://tiktok.com/@aacsearch'
    },
    {
        icon: 'web-icon-instagram',
        label: 'Instagram',
        link: 'https://instagram.com/aacsearch.io'
    }
];
